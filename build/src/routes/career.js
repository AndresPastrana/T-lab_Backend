...
exports.router.put("/:id", [(0, express_validator_1.param)("id", "Not a valid MongoId").isMongoId(), checkForErrors], carrer_1.updateCareer);
exports.router.delete("/:id", [(0, express_validator_1.param)("id", "Invalid Mongo id").isMongoId(), checkForErrors], carrer_1.deleteCareer);
